...
function calculator(x, y){
  return function (callback){
    ...
    */
    var subtração = calculator(2,4);
  
    var adição = calculator(67,345);
  
    var multiplicação = calculator(3456,67);
  
    var divisão = calculator(555,88);
  
    var mod = calculator(34, 2345);
    ...
    */
    ...
    multiplicação(function(num1, num2){
      return num1*num2;
    }) );

    console.log( 'O resultado da divisão é:' );
    divisão(function(num1, num2){
      return num1/num2;
    }) );
